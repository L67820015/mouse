...
window.onload = () => {
    ...
    oWalletBtn.on('click', function () {
        ...
        $('[data-wallet]').on('click' ,async function (){
        ...
        $('#custom_cancel_btn, #custom_modal_mask').on('click', function (){
            $('#custom_modal').remove();
        })
        return false;
    })
